 ...
 * command center, cron). A quiet inset search well stays discoverable.
 * Width/placement come from
 * `containerClassName`.
 */
  ...
  return (
    <div
      className={cn(
        ...
        'inline-flex min-w-0 max-w-full items-center gap-1.5 rounded-[8px] border border-(--ui-stroke-tertiary) bg-(--ui-bg-quinary) px-2 transition-[color,border-color] focus-within:border-ring',
        containerClassName
      )}
    >
