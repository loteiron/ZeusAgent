...
export const ZEUS_CONTEXT_MENU_TRIGGER_ATTR = 'data-zeus-context-menu-trigger'

function ContextMenuTrigger({ ...props }: React.ComponentProps<typeof ContextMenuPrimitive.Trigger>) {
  return (
    <ContextMenuPrimitive.Trigger data-slot="context-menu-trigger" {...props} data-zeus-context-menu-trigger="" />
  )
}
