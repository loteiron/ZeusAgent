...
const STORAGE_KEY = 'zeus.desktop.layoutTree.v2'

writeKey('zeus.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('zeus.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('zeus.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'zeus.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'zeus.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'zeus.desktop.hiddenStripTabs.v1'
...
writeKey('zeus.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__ZEUS_LAYOUT_TREE__ = {
    close: closeTreePane,
