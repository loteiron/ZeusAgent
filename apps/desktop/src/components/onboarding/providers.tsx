...
import type { OAuthProvider } from '@/types/zeus'
...
export function FeaturedProviderRow({
  ...
  return (
    <button
      className="group relative flex w-full items-center justify-between gap-4 rounded-[8px] border border-(--ui-stroke-secondary) bg-primary/[0.06] px-3 py-2.5 text-left transition-colors hover:border-primary hover:bg-primary/10"
      ...
      <div className="min-w-0">
        <div className="flex items-center gap-2">
          ...
          {loggedIn ? (
            ...
            <span className="inline-flex items-center rounded-[4px] bg-primary px-2 py-0.5 text-[0.64rem] font-semibold text-primary-foreground">
