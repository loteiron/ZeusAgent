...
// (#73044). Exercises the REAL zeus + store/gateway + store/profile chain:
...
const { pluginSocket, setApiRequestConnection, setApiRequestProfile } = await import('@/zeus')
...
const conn = (over: Partial<ZeusAgentConnection> = {}): ZeusAgentConnection =>
  ({
    authMode: 'oauth',
