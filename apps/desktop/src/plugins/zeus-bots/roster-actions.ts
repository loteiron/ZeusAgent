...
import { ackStoredSessionId, atom, haptic, host, markSessionUnreadFinished } from '@zeus/plugin-sdk'
 ...
 *  (zeus-agent#90102) and are discarded. Without `canonical_session` (older
