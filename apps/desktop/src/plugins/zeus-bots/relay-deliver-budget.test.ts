...
const relaySource = readFileSync(join(process.cwd(), 'src/plugins/zeus-bots/relay.ts'), 'utf8')
const repoRoot = join(process.cwd(), '..', '..')
const configDefaults = readFileSync(join(repoRoot, 'zeus_cli/config_defaults.py'), 'utf8')
