...
import type { ZeusAgentPlugin, PaletteContribution } from '@zeus/plugin-sdk'
import { $accentOverride, PALETTE_AREA, setAccentOverride, STATUSBAR_AREAS } from '@zeus/plugin-sdk'

import { AccentPickerTrigger } from './picker'

const plugin: ZeusAgentPlugin = {
  id: 'accent',
  name: 'Accent Picker',
  description:
