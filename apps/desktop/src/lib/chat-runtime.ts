...
import type { ModelOptionsResponse, SessionInfo } from '@/types/zeus'
 ...
 *
 * Only the leading status prefix (e.g. "ZeusAgent is thinking...") and the
 ...
 *  resolved comment as JSON (ZeusAgentPrComment shape); a malformed payload falls
