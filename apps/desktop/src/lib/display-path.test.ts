...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/zeus-agent')).toBe('~/www/zeus-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/zeus-agent')).toBe('zeus-agent')
    expect(pathLeaf('~/www/zeus-agent')).toBe('zeus-agent')
