...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|zeus):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.zeusDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.zeusDesktop?.openExternal?.(href)
  }
}
 ...
 * doesn't cost a context switch out of ZeusAgent, and it is the surface the agent
