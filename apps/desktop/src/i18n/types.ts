...
export interface Translations {
  ...
  boot: {
    ...
    steps: {
      ...
      startingZeusAgentDesktop: string
    }
    errors: {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshZeusAgentPathTitle: string
      sshZeusAgentPathDesc: string
      sshZeusAgentPathPlaceholder: string
  ...
  commandCenter: {
    ...
    zeusActiveSessions: (version: string, count: number) => string
