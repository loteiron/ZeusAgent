...
export const en: Translations = {
  sessionImport: {
    ...
    subtitle: 'Bring a conversation into ZeusAgent and pick up where you left off.',
    ...
    chooseHelp: 'Choose a session to read its history before bringing it into ZeusAgent.',
    ...
    you: 'You',
    snapshot: 'This conversation is already in ZeusAgent. Open your existing copy to continue.',
    copyNotice:
      'Copies conversation text. Source files stay unchanged. Tool output and reasoning are not carried over.',
    importing: 'Importing…',
    open: 'Open in ZeusAgent',
    continue: 'Continue in ZeusAgent',
  ...
  boot: {
    ready: 'ZeusAgent Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading ZeusAgent settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote ZeusAgent backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingZeusAgentDesktop: 'Starting ZeusAgent Desktop…'
    },
    errors: {
      backgroundExited: 'ZeusAgent background process exited.',
      backgroundExitedDuringStartup: 'ZeusAgent background process exited during startup.',
    ...
    failure: {
      title: "ZeusAgent couldn't start",
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your ZeusAgent backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateZeusAgent: 'Update ZeusAgent',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting ZeusAgent Desktop.',
    ...
    native: {
      ...
      inputBody: 'ZeusAgent is waiting for your response.',
      turnDoneTitle: 'ZeusAgent finished',
      turnDoneBody: '',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'You can also run `zeus debug share --nous` from a terminal, or `zeus debug share --local` to print the report without uploading.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to ZeusAgent defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the ZeusAgent backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the ZeusAgent backend to manage this plugin from Desktop.',
      ...
      installModal: {
        ...
        agentTargetLocal: profile => `Installs into the ${profile} backend (~/.zeus/plugins/)`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while ZeusAgent is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'ZeusAgent asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while ZeusAgent was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while ZeusAgent was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let ZeusAgent follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and ZeusAgent can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by ZeusAgent when it helps. Closing one retires it for good.',
      tipsReset: (count: number) => `Bring back ${count} closed ${count === 1 ? 'tip' : 'tips'}`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let ZeusAgent walk you through the app, dimming the screen and spotlighting each step.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what ZeusAgent is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen ZeusAgent, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      bundleOutOfSyncDesc:
        'The ZeusAgent runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      bundleOutOfSyncAction: 'Get the installer',
      bundleSwapPending: 'Restart to finish the update',
      bundleSwapPendingDesc:
        'The updated app is already installed — ZeusAgent only needs to restart to load it. Chats and settings are untouched.',
      bundleSwapPendingAction: 'Restart ZeusAgent',
      updates: 'Updates',
      checkNow: 'Check now',
      checking: 'Checking…',
      seeWhatsNew: "See what's new",
      ...
      automaticUpdatesDesc:
        'ZeusAgent checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading ZeusAgent configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening ZeusAgent.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every ZeusAgent gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by ZeusAgent Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'ZeusAgent Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The ZeusAgent runtime managed by this app.',
      kindRemoteDesc: 'A ZeusAgent gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your ZeusAgent Cloud account.',
      kindSshDesc: 'A ZeusAgent install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers ZeusAgent manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under ZeusAgent Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a ZeusAgent backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      ...
      localDesc: 'Start a private ZeusAgent backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote ZeusAgent backend.',
      ...
      cloudDesc: 'Sign in once to ZeusAgent Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'ZeusAgent Cloud',
      cloudSignIn: 'Sign in to ZeusAgent Cloud',
      cloudSignedIn: 'Signed in to ZeusAgent Cloud',
      cloudNeedsSignIn: 'Sign in to ZeusAgent Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your ZeusAgent Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'ZeusAgent Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of ZeusAgent Cloud',
      cloudSignedOutMessage: 'Cleared the ZeusAgent Cloud session.',
      ...
      restartingMessage: 'ZeusAgent Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · ZeusAgent ${version}` : ''}`,
      ...
      sshDesc:
        'ZeusAgent is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshZeusAgentPathTitle: 'ZeusAgent path (optional)',
      sshZeusAgentPathDesc: 'Full path to the remote zeus binary. Blank = auto-detect.',
      sshZeusAgentPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — ZeusAgent found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — ZeusAgent runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'ZeusAgent is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) or set the ZeusAgent path.',
      sshErrPlatform:
        'Unsupported remote platform. ZeusAgent Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update ZeusAgent on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to ZeusAgent. Review the exact configuration below — it comes from the link, not from ZeusAgent.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend} backend. ZeusAgent starts and manages the server for you.`,
      ...
      upToDateDetail: (tag, backend) => `Running llama.cpp ${tag} (${backend}) — the latest build ZeusAgent ships.`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. ZeusAgent runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point ZeusAgent at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Let ZeusAgent browse with a snapshot of your default browser profile, so sites open already signed in.',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via zeus curator restore.',
  ...
  starmap: {
    ...
    emptyDesc: 'As ZeusAgent builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart ZeusAgent to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update ZeusAgent to generate pets.',
      backgroundHint: 'You can close this — ZeusAgent will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure ZeusAgent desktop' },
    ...
    zeusActiveSessions: (version, count) => `ZeusAgent ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote ZeusAgent you point it at, instead of this computer.',
      urlLabel: 'Remote address',
      urlPlaceholder: 'https://zeus.example.com',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent ZeusAgent environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'ZeusAgent did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. ZeusAgent will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the ZeusAgent backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from ZeusAgent. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the ZeusAgent backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting ZeusAgent...',
    placeholderReconnecting: 'Reconnecting to ZeusAgent…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give ZeusAgent a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'ZeusAgent will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask ZeusAgent to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating ZeusAgent…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting ZeusAgent…',
    ...
    unsupportedMessage: 'This version of ZeusAgent can’t update itself from inside the app.',
    ...
    manualBody: 'You installed ZeusAgent from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'ZeusAgent will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the ZeusAgent desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The ZeusAgent updater takes over in its own window and reopens ZeusAgent automatically when it’s done. Please don’t reopen ZeusAgent yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. ZeusAgent reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then ZeusAgent reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update ZeusAgent?',
    blockerBody:
      'ZeusAgent needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update ZeusAgent',
    foreignBlockerBody:
      'ZeusAgent can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'ZeusAgent can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'ZeusAgent needs a one-time install',
    ...
    setupChoiceTitle: 'Set up ZeusAgent Desktop',
    setupChoiceDesc:
      'Connect this app to a ZeusAgent gateway you already run, or install ZeusAgent locally on this computer.',
    connectExistingTitle: 'Connect to existing ZeusAgent',
    ...
    installLocalTitle: 'Install ZeusAgent locally',
    installLocalDesc: 'Download ZeusAgent, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart ZeusAgent Desktop and try again.',
    remoteSetupTitle: 'Connect to existing ZeusAgent',
    remoteSetupDesc: 'Enter your gateway URL. ZeusAgent Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the ZeusAgent gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/zeus',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that ZeusAgent gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up ZeusAgent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another ZeusAgent CLI or desktop instance is running. Stop any running ZeusAgent instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with ZeusAgent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'ZeusAgent is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting ZeusAgent…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run ZeusAgent',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point ZeusAgent at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — ZeusAgent connects automatically',
    ...
    authorizeThere: 'Authorize ZeusAgent there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize ZeusAgent there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. ZeusAgent will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'ZeusAgent is restarting...',
      askRestart: 'Ask ZeusAgent to restart the server',
      lookingRestart: taskId => `ZeusAgent is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'ZeusAgent is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask ZeusAgent to open a page.',
      finishedRestarting: message => `ZeusAgent finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'ZeusAgent could not restart the server.',
      stillWorking:
        'ZeusAgent is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'ZeusAgent is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'ZeusAgent gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.zeus/config.yaml). ZeusAgent won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'ZeusAgent needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'ZeusAgent needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart ZeusAgent Desktop to use Save Image.',
    restartToSaveImages: 'Restart ZeusAgent Desktop to save images',
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions ZeusAgent loads when the work calls for them.'
      },
      messaging: {
        title: 'ZeusAgent away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything ZeusAgent made',
      ...
      profiles: {
        ...
        text: 'Each one is its own ZeusAgent — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
