...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('zeus.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('zeus.desktop.unreadFinishedSessions')
