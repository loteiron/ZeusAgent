...
const POPOUT_STORAGE_KEY = 'zeus.desktop.composerPopout.zones.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'zeus.desktop.composerPopout.gesturesEnabled'
...
const LEGACY_ENABLED_KEY = 'zeus.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'zeus.desktop.composerPopout.position'
