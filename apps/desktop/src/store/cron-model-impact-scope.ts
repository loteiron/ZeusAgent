...
function identityForConnection(connection: ZeusAgentConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: ZeusAgentConnection | null): void {
