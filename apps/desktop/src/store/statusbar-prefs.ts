...
// v1 (`zeus.desktop.statusbarHidden`) was seeded with the approval pill
...
const STATUSBAR_HIDDEN_STORAGE_KEY = 'zeus.desktop.statusbarHidden.v2'
const LEGACY_HIDDEN_STORAGE_KEY = 'zeus.desktop.statusbarHidden'
// v1 (`zeus.desktop.statusbarVisible`) shipped a stretch where the bar was
...
const STATUSBAR_VISIBLE_STORAGE_KEY = 'zeus.desktop.statusbarVisible.v2'
