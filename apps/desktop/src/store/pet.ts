...
export interface PetInfo {
  ...
  // the ZeusAgent "run" activity state uses the in-place running row).
 ...
 * ZEUS_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'zeus.desktop.pet-roam.v1'
