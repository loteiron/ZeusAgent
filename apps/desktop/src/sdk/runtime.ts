 ...
 * plugins resolve `@zeus/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __ZEUS_PLUGIN_SDK__: sdk,
  __ZEUS_REACT__: React,
  __ZEUS_REACT_JSX__: jsxRuntime,
  __ZEUS_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@zeus/plugin-sdk': shimUrl('__ZEUS_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__ZEUS_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__ZEUS_REACT_JSX__'),
    react: shimUrl('__ZEUS_REACT__')
  }
