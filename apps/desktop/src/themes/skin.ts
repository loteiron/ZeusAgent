/**
 * ZeusAgent skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$ZEUS_HOME/skins/` (or a
 * built-in) resolved by `zeus_cli/skin_engine.py` and pushed to every surface
 ...
 * skin ZeusAgent authors from a prompt lights up all three surfaces from one file.
 *
...
import type { ZeusAgentSkin, SkinColors } from '@zeus/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: ZeusAgentSkin): DesktopTheme | null {
