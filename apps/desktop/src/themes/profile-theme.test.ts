...
import { DEFAULT_SKIN_NAME, LEGACY_SKIN_NAMES } from './presets'
...
describe('retired desktop skins', () => {
  beforeEach(() => window.localStorage.clear())

  it.each(Object.keys(LEGACY_SKIN_NAMES))('migrates a saved %s choice without changing the profile mode', name => {
    skinPref.assign('work', name)
