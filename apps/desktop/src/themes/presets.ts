/**
 * Zeus is an independently authored desktop identity. Other named palettes
 * remain optional open source editor themes; user imports use the same model.
 * Retired fork skin names are resolved by the compatibility map below.
 */
...
const SYSTEM_SANS =
  '"Segoe UI Variable Text", "Segoe UI", -apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", system-ui, sans-serif, ' +
  EMOJI_FALLBACK

const SYSTEM_MONO = '"JetBrains Mono", Menlo, Monaco, "SF Mono", "Courier Prime", monospace, ' + EMOJI_FALLBACK

export const DEFAULT_TYPOGRAPHY: DesktopThemeTypography = { fontSans: SYSTEM_SANS, fontMono: SYSTEM_MONO }

/** Optional GitHub editor palette, independent from the Zeus identity. */
...
export const zeusTheme: DesktopTheme = {
  name: 'zeus',
  label: 'Zeus · Storm & Copper',
  description: 'Storm blue workspaces with copper actions',
  colors: {
    background: '#EAF0F7',
    foreground: '#162743',
    card: '#F7FAFD',
    cardForeground: '#162743',
    muted: '#DFE8F1',
    mutedForeground: '#51657C',
    popover: '#FFFFFF',
    popoverForeground: '#162743',
    primary: '#A85F32',
    primaryForeground: '#FFFFFF',
    secondary: '#DEE8F2',
    secondaryForeground: '#284C6E',
    accent: '#D9E5F0',
    accentForeground: '#162743',
    border: '#C5D3E2',
    input: '#FFFFFF',
    ring: '#315B83',
    midground: '#315B83',
    ...
    destructive: '#B93D4C',
    destructiveForeground: '#FFFFFF',
    sidebarBackground: '#DCE6F0',
    sidebarBorder: '#B9CADC',
    userBubble: '#DCE8F3',
    userBubbleBorder: '#B9CADC'
  },
  darkColors: {
    background: '#101D31',
    foreground: '#E5EDF7',
    ...
    muted: '#203650',
    mutedForeground: '#A9BDD3',
    popover: '#203650',
    popoverForeground: '#E5EDF7',
    primary: '#E6AB80',
    primaryForeground: '#101D31',
    secondary: '#29415D',
    secondaryForeground: '#D7E6F4',
    accent: '#2B4663',
    accentForeground: '#E5EDF7',
    border: '#38516D',
    input: '#172842',
    ring: '#92B9DD',
    midground: '#92B9DD',
    midgroundForeground: '#101D31',
    composerRing: '#92B9DD',
    destructive: '#F18E97',
    destructiveForeground: '#101D31',
    sidebarBackground: '#132238',
    sidebarBorder: '#314961',
    userBubble: '#243D58',
    userBubbleBorder: '#44627F'
  },
  typography: DEFAULT_TYPOGRAPHY
}

/** Resolve old saved choices without offering retired branding in the picker. */
export const LEGACY_SKIN_NAMES: Readonly<Record<string, string>> = {
  nous: 'zeus',
  'nous-alt': 'zeus',
  'nous-light': 'zeus',
  default: 'zeus',
...
export const DEFAULT_SKIN_NAME = 'zeus'
