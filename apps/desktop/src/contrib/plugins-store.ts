 ...
 * `<zeus home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'zeus.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'zeus.desktop.disabledPlugins.v1'
