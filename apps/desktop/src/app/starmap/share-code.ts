...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/zeus'
...
const VERSION = 3
const PREFIX = 'HML' // "ZeusAgent Memory Loadout" — namespaces our codes like WoW's leading bytes.
