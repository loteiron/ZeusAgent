...
const TAKEOVER_KEY = 'zeus.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which ZeusAgent can't clear via the API — the user
 *  sees exactly what runs instead of ZeusAgent silently deleting their creds. */
