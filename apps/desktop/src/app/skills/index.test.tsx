...
import type * as ZeusAgentApi from '@/zeus'
...
vi.mock('@/zeus', async importOriginal => ({
  ...(await importOriginal<typeof ZeusAgentApi>()),
...
describe('SkillsView toolset management', { timeout: 60_000 }, () => {
    ...
    await act(async () => {
      window.dispatchEvent(
        new MessageEvent('message', {
          data: { type: 'zeus-skill-pick', name: 'web-research', identifier: 'web-research' },
  ...
  it('offers (connection, profile) scope rows on multi-connection desktops', async () => {
    ...
    ;(window as { zeusDesktop?: unknown }).zeusDesktop = { connections, getAgentRoster }
