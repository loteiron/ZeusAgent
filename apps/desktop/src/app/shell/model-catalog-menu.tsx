...
import { getLocalModelsStatus } from '@/zeus'
...
import type { LocalModelLoadProgress, ModelOptionProvider, ModelOptionsResponse } from '@/types/zeus'
 ...
 * Returning `{}` is fine — the row then shows ZeusAgent' defaults.
 */
