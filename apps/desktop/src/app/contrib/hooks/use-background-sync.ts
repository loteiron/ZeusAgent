...
import { getLatestSessionMessages, type ProfileScope } from '@/zeus'
...
interface BackgroundSyncParams {
  ...
  refreshZeusAgentConfig: () => Promise<unknown> | unknown
...
export function useBackgroundSync({
  ...
  }, [activeSessionId, freshDraftReady, gatewayState, refreshCurrentModel, refreshZeusAgentConfig])
}
