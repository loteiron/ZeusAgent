              ...
              <div className="min-w-0">
                {version?.bundleSwapPending ? (
                  ...
                  <>
                    ...
                    <Button
                      className="mt-2"
                      onClick={() => void window.zeusDesktop?.relaunchApp?.()}
                      size="sm"
                      variant="textStrong"
                    >
                  ...
                  <>
                    ...
                    <p className="mt-2 text-xs text-muted-foreground">
                      Rebuild this ZeusAgent source package with python scripts/setup_zeus.py --desktop.
                    </p>
                  </>
                )}
              </div>
            ...
            <Button asChild className="ml-auto" size="sm" variant="text">
              <a
                ...
                onClick={event => {
                  ...
                  void window.zeusDesktop?.openExternal?.(RELEASE_NOTES_URL)
                }}
                rel="noreferrer"
                target="_blank"
              >
