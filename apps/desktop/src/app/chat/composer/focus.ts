...
const FOCUS_EVENT = 'zeus:composer-focus'
const INSERT_EVENT = 'zeus:composer-insert'
const ATTACH_IMAGES_EVENT = 'zeus:composer-attach-images'
const INSERT_REFS_EVENT = 'zeus:composer-insert-refs'
const SUBMIT_EVENT = 'zeus:composer-submit'
const VOICE_TOGGLE_EVENT = 'zeus:composer-voice-toggle'
const MODEL_MENU_EVENT = 'zeus:composer-model-menu'
