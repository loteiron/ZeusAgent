...
function harness(gateway: ZeusAgentGateway) {
...
describe('useSlashCompletions', () => {
  it('serves the bare-slash catalog from cache instead of re-requesting it', async () => {
    ...
    const api = harness({ request } as unknown as ZeusAgentGateway)
  ...
  // ones that shipped with ZeusAgent and were never opened.
