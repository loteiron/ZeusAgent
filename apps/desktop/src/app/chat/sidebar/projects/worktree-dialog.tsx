...
import type { ZeusAgentGitBranch } from '@/global'
...
const branchActionLabel = (branch: ZeusAgentGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<ZeusAgentGitBranch[]>([])
  ...
  const convert = async (branch: ZeusAgentGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
