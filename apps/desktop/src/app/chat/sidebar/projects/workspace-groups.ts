...
import type { ProjectInfo, SessionInfo } from '@/zeus'
 ...
 * repo shows its branches/worktrees even when they have no ZeusAgent sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: ZeusAgentGitWorktree[]
): SidebarSessionGroup[] {
