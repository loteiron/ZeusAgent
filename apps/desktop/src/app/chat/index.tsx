...
import type { ModelOptionsResponse } from '@/types/zeus'
...
function ChatHeader({
  ...
  return (
    <header className={cn('z-workspace-header', titlebarHeaderBaseClass, isRoutedSessionView && titlebarHeaderShadowClass)}>
      <div
