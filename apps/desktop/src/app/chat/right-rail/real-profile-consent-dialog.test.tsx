...
vi.mock('@/zeus', () => ({
  saveZeusAgentConfigRecord: (config: Record<string, unknown>, profile?: unknown) => mocks.save(config, profile)
}))

const promptCopy = {
  title: 'Stay signed in to your sites',
  body: 'Let ZeusAgent browse with a snapshot of your default browser profile.',
...
vi.mock('../../hooks/use-config-record', () => ({
  zeusConfigCacheWriter: () => (config: Record<string, unknown>) => mocks.cache(config),
  useZeusAgentConfigRecord: () => ({ data: mocks.loadedConfig })
}))
