...
import { getZeusAgentConfigRecord, listAllProfileSessions } from '@/zeus'
...
// ZeusAgent session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
...
function CommandPaletteBody({ onExited }: { onExited: () => void }) {
  ...
  const configQuery = useQuery({
    ...
    queryFn: () => getZeusAgentConfigRecord()
  })
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-zeus',
            keywords: ['update', 'upgrade', 'zeus', 'version', 'system', 'restart'],
            label: cc.updateZeusAgent,
