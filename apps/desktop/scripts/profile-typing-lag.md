...
cd apps/desktop
XCURSOR_SIZE=24 ZEUS_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/zeus-typing
# → /tmp/zeus-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/zeus-typing.before.heapsnapshot
# → /tmp/zeus-typing.after.heapsnapshot
```
