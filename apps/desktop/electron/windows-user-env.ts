...
// even though a fresh shell — and the ZeusAgent CLI — sees it immediately. The
// desktop's ZEUS_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\zeus. Reading
...
//       ZEUS_HOME    REG_SZ    F:\ZeusAgent\data
//
