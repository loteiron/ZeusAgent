...
// by main.ts (`setBackgroundThrottling` driven by the merged `zeus:active-work`
...
// (the "ZeusAgent idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey ZeusAgent" wake word has NO preceding click,
