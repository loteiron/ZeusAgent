import type { BillingBlock, UsageModelData } from '@zeus/shared/billing'
import type { ZeusAgentSkin } from '@zeus/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@zeus/shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = ZeusAgentSkin
