import { Box, type ScrollBoxHandle, stringWidth, Text } from '@zeus/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (ZEUS_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (ZEUS_DEV_CREDITS), lowest priority,
