import { Box, NoSelect, Text } from '@zeus/ink'
...
// One measured pulse for reasoning; a sweep marks work in progress.
const THINK: BrailleSpinnerName[] = ['pulse']
const TOOL: BrailleSpinnerName[] = ['scan']
