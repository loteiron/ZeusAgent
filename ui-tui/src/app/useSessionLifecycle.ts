...
import type { ScrollBoxHandle } from '@zeus/ink'
import { evictInkCaches } from '@zeus/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.ZEUS_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
