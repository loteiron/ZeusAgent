 ...
 * across theme x background scenes to <tmpdir>/zeus-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@zeus/ink'
...
// The regenerated slate light_colors block from zeus_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/zeus-agent',
...
const setup = (bgHex: string) => {
  process.env.ZEUS_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
