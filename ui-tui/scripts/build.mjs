...
await build({
  ...
  // Skip the prebuilt @zeus/ink bundle and inline the source instead:
  ...
  alias: { '@zeus/ink': resolve(root, 'packages/zeus-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The zeus_cli launcher
