/**
 * ZeusAgent desktop plugin template. Save as:
 *   <zeus home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <zeus home> is ~/.zeus by default, or ~/.zeus/profiles/<name>
 * when running a named profile (`zeus -p <name>`). Run `zeus doctor` (or
 ...
 * Only these imports resolve: @zeus/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@zeus/plugin-sdk'
