...
Registry of record: `zeus_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore ZeusAgent config+state snapshots (CLI)
...
/update                  Update ZeusAgent to latest
