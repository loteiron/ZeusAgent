...
Standard library only, so it runs in any ZeusAgent environment without an install
...
USER_AGENT = "zeus-agent/1.0 (rss-feeds skill; +https://github.com/NousResearch/hermes-agent)"
TIMEOUT = 20
NS = {
