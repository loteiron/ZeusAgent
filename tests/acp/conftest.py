...
Keeps the ACP server tests offline: ``ZeusAgentACPAgent._build_model_state``
calls ``zeus_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import zeus_cli.inventory as inventory
