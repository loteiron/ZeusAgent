"""Regression test: zeus update must not load cryptography eagerly."""
...
assert 'zeus_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running zeus update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so zeus_cli is importable,
