"""Tests for the shared tar.gz writer (``zeus_cli.archive_safe.make_targz``).

``make_targz`` backs both ``zeus profile export`` and ``zeus kanban
...
from zeus_cli.archive_safe import make_targz
