"""Tests for the interactive session browser (`zeus sessions browse`).
...
from zeus_cli.sessions_cmd_browse import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """zeus sessions browse should be parseable."""
