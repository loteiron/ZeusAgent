...
class TestGetCopilotModelContext:
    ...
    @patch("zeus_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("zeus_cli.models._urlopen_model_catalog_request")
    ...
    @patch("zeus_cli.models.fetch_github_model_catalog", return_value=[])
