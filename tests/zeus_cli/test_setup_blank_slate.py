"""Tests for Blank Slate setup mode (zeus_cli/setup.py).
...
from zeus_cli.setup_quick import _blank_slate_minimal_toolsets, _blank_slate_minimize_config
