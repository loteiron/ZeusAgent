...
from zeus_cli.commands import GATEWAY_KNOWN_COMMANDS, SUBCOMMANDS, gateway_help_lines, resolve_command
from zeus_cli.commands_completion import SlashCommandCompleter
from zeus_cli.commands_platforms import telegram_bot_commands
...
def _isolate_config(monkeypatch, home):
    ...
    monkeypatch.setenv("ZEUS_MANAGED_DIR", str(home / "missing-managed"))
    from zeus_cli import managed_scope
    from zeus_cli.config import _LOAD_CONFIG_CACHE, _RAW_CONFIG_CACHE
