...
from zeus_cli import desktop_update_verify as verify
from zeus_cli.main_desktop import _write_desktop_build_stamp
...
def bundle(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(verify, '_desktop_packaged_executable', lambda _: resources.parent / 'ZeusAgent.exe')
    ...
    monkeypatch.setattr(main_desktop, '_desktop_packaged_executable', lambda _: resources.parent / 'ZeusAgent.exe')
