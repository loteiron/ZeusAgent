...
Run before any catalog commit:
    ...
    ZEUS_TEST_NETWORK=1 scripts/run_tests.sh tests/zeus_cli/test_catalog_reachability.py
"""
...
pytestmark = pytest.mark.skipif(
    not os.environ.get("ZEUS_TEST_NETWORK"),
    reason="network test; set ZEUS_TEST_NETWORK=1 to run",
)
