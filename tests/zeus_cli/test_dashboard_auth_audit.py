...
Profile-aware location: ``$ZEUS_HOME/logs/dashboard-auth.log``.
...
from zeus_cli.dashboard_auth.audit import audit_log, AuditEvent


@pytest.fixture
def profile_home(tmp_path, monkeypatch):
    """Redirect $ZEUS_HOME and ~ to a tmp dir for the duration of the test."""
    home = tmp_path / ".zeus"
    home.mkdir()
