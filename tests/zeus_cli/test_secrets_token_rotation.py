"""Tests for `zeus secrets bitwarden token` / `zeus secrets onepassword token`.
...
from zeus_cli import onepassword_secrets_cli as op_cli
from zeus_cli import secrets_cli as bw_cli
