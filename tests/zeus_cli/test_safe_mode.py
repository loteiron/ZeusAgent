"""Tests for `zeus chat --safe-mode` isolation."""
...
_VARS = ("ZEUS_SAFE_MODE", "ZEUS_IGNORE_USER_CONFIG", "ZEUS_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["ZEUS_SAFE_MODE"] == "1"
        assert os.environ["ZEUS_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["ZEUS_IGNORE_RULES"] == "1"
        return True
