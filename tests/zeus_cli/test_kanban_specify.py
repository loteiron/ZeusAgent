"""Tests for the specifier module + `zeus kanban specify` CLI surface.
...
from zeus_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `zeus kanban …` argparse surface directly."""
