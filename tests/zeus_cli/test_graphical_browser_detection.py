"""Tests for `_can_open_graphical_browser()` in zeus_cli.auth.

Guards the fix for the May 2026 report where `zeus auth add xai-oauth`
...
from zeus_cli.auth import _can_open_graphical_browser
