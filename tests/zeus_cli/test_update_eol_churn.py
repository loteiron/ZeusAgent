"""Regression: ``zeus update`` should take a managed checkout off autocrlf=true.
...
``zeus update`` has to repair them.
...
from zeus_cli.update_cmd import _normalize_managed_eol
