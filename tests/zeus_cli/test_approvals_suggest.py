"""Tests for ``zeus approvals suggest`` (zeus_cli/approvals_suggest.py).

Approval history in ZeusAgent is implied, not ledgered: the session DB
...
from zeus_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
