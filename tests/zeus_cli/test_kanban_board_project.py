...
A kanban board can be scoped to a first-class ZeusAgent project so every task on
...
def fresh_home(tmp_path, monkeypatch):
    ...
    for var in ("ZEUS_KANBAN_DB", "ZEUS_KANBAN_WORKSPACES_ROOT", "ZEUS_KANBAN_HOME", "ZEUS_KANBAN_BOARD"):
