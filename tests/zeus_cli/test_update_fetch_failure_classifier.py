"""Fetch-failure classification for `zeus update` / `zeus update --check`.
...
def test_update_network_git_calls_never_prompt_for_credentials():
    ...
    Live incident (Sep 2026): a GitHub-side 401 made `zeus update` sit on
    ...
    from zeus_cli import update_cmd_git
