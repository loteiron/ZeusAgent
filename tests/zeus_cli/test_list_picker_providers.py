...
import zeus_cli.model_switch_providers as zeus_cli_model_switch_providers
...
def test_passthrough_kwargs_to_base(monkeypatch):
    ...
    monkeypatch.setattr(zeus_cli_model_switch_providers, "list_authenticated_providers", _capture)
    monkeypatch.setattr("zeus_cli.models.fetch_openrouter_models",
                        lambda *a, **kw: [])
...
def _stub_kimi_discovery(monkeypatch, *, canonical):
    ...
    import zeus_cli.models as hm
    import zeus_cli.models_catalog_static as zeus_cli_models_catalog_static
    from zeus_cli import models_catalog_static
    ...
    monkeypatch.setattr(zeus_cli_models_catalog_static, "CANONICAL_PROVIDERS", canonical)
