...
The oneshot path builds its AIAgent directly (bypassing ZeusAgentCLI), so the
...
from zeus_cli.oneshot import _build_preloaded_skills_prompt, _normalize_skills
