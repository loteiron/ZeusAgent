...
import pytest
from zeus_cli import model_switch_providers


# ---------------------------------------------------------------------------
# Thread-safe cache entry update (zeus_cli/models.py)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Parallel prefetch (zeus_cli/model_switch.py)
# ---------------------------------------------------------------------------
...
class TestPrefetchProviderModelsParallel:
    ...
    def test_skips_all_fresh_entries(self, monkeypatch):
        ...
        from zeus_cli.model_switch_providers import _prefetch_provider_models_parallel
        ...
        with patch("zeus_cli.models._load_provider_models_cache", return_value=fresh_cache), \
             patch("zeus_cli.models._credential_fingerprint", return_value="fp"), \
             patch("zeus_cli.models.cached_provider_model_ids") as fetch:
    ...
    def test_fetches_only_stale_entries(self, monkeypatch):
        ...
        with patch("zeus_cli.models._load_provider_models_cache", return_value=cache), \
             patch("zeus_cli.models._credential_fingerprint", return_value="fp_f"), \
             patch("zeus_cli.models.cached_provider_model_ids", side_effect=mock_fetch), \
             patch("zeus_cli.models.update_provider_cache_entry"):
    ...
    def test_fetches_in_parallel(self, monkeypatch):
        ...
        with patch("zeus_cli.models._load_provider_models_cache", return_value={}), \
             patch("zeus_cli.models._credential_fingerprint", return_value="fp"), \
             patch("zeus_cli.models.cached_provider_model_ids", side_effect=mock_fetch), \
             patch("zeus_cli.models.update_provider_cache_entry"):
    ...
    def test_empty_list_is_noop(self):
        ...
        with patch("zeus_cli.models.cached_provider_model_ids") as fetch:
...
class TestPrefetchIntegration:
    ...
    def test_prefetch_called_with_more_than_3_providers(self):
        ...
        from zeus_cli import model_switch
