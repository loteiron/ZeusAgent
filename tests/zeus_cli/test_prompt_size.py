"""Tests for the ``zeus prompt-size`` diagnostic (issue #34667)."""
...
from zeus_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(zeus_home, memory_text="", user_text=""):
    mem_dir = zeus_home / "memories"
...
def _seed_skill(zeus_home, name, description):
    skill_dir = zeus_home / "skills" / "demo" / name
