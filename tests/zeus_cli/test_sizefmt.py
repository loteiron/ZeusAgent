"""Tests for the shared byte formatter (zeus_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from zeus_cli.backup import _format_size as backup
    from zeus_cli.checkpoints import _fmt_bytes as checkpoints
    from zeus_cli.sizefmt import format_bytes as doctor
