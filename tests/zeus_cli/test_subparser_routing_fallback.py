...
The main() function in zeus_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `zeus -c model`
...
def _build_parser():
    """Build a minimal replica of the zeus top-level parser."""
