...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (zeus_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_zeus_overlays():
    """zeus_cli.providers.get_provider("vertex") backs
