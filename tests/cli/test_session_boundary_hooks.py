...
from zeus_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/zeus_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("zeus_cli.lifecycle.invoke_hook")
@patch("zeus_cli.lifecycle.finalize_session")
