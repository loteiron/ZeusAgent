...
Root cause: ``ZeusAgentCLI.chat()`` fires ``agent.interrupt(msg)`` from its
...
def _make_cli():
    """Build a ZeusAgentCLI with prompt_toolkit stubbed (same pattern as
