...
must match regardless of host OS (a Linux-hosted ZeusAgent can still drive a
...
class TestWindowsPathVariant:
    ...
    @pytest.mark.parametrize("cmd", [
        ...
        r"copy C:\Users\me\AppData\Local\zeus\.env D:\exfil\e.txt",
        "cat C:/Users/me/AppData/Local/zeus/.env",
    ])
