...
def make_zeus_home(base: Path, journal_mode: str) -> Path:
    """Create an isolated ZEUS_HOME whose config pins ``database.journal_mode``.
    ...
    """
    home = base / f"zeus-home-{journal_mode}"
