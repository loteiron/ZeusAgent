...
manipulation. ZeusAgent keeps canonical conversation history in state.db and may
...
def fake_homes(tmp_path, monkeypatch):
    """Point ZEUS_HOME at a temp profile dir.

    Uses the real env-var resolution chain (get_zeus_home /
    get_default_zeus_root) instead of monkeypatching private helpers —
    ...
    ZEUS_HOME=<root>/profiles/<name> makes get_default_zeus_root()
