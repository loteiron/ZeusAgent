"""Tests for _setup_feishu() in zeus_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("zeus_cli.config.save_env_value", side_effect=mock_save), \
         patch("zeus_cli.config.get_env_value", side_effect=mock_get), \
         patch("zeus_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("zeus_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("zeus_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("zeus_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("zeus_cli.cli_output.print_header"), \
         patch("zeus_cli.cli_output.print_info"), \
         patch("zeus_cli.cli_output.print_success"), \
         patch("zeus_cli.cli_output.print_warning"), \
         patch("zeus_cli.cli_output.print_error"), \
