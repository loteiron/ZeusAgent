...
def _patch_aborted_startup(monkeypatch, runner_cls):
    ...
    monkeypatch.setattr("zeus_logging.setup_logging", lambda zeus_home, mode: None)
...
async def test_failure_exit_still_stops_cron_housekeeping_and_mcp(monkeypatch):
    ...
    monkeypatch.setattr("zeus_cli.nous_auth_keepalive.stop_nous_auth_keepalive", lambda: None)
