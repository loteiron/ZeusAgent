...
def store(tmp_path, monkeypatch):
    ...
    ~/.zeus/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at zeus_state import time, before pytest's ZEUS_HOME monkeypatch
    fires — the autouse fixture's ZEUS_HOME override doesn't help here.)
    """
    import zeus_state
