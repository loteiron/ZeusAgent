...
The unit tests in tests/zeus_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned zeus-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/zeus")
from zeus_cli.service_manager import S6ServiceManager
