"""Session <-> workspace grouping key (zeus_state_sessions.workspace_key).

The key is what `zeus sessions list --workspace` groups/filters on. It is a
...
import zeus_state_sessions
from zeus_state_sessions import workspace_key
