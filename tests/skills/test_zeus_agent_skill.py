"""The `zeus-agent` skill is what a running ZeusAgent knows about itself.

`website/` is never packaged, so an installed ZeusAgent has no local copy of the
user guide; skills ARE synced into `$ZEUS_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "ZeusAgent can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "zeus-agent"
