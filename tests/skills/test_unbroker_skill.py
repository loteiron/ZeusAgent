...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and zeus-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # zeus-agent (tests/skills/)
]
