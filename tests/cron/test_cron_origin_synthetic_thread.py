...
class TestSlackSyntheticThreadCapture:
    def test_synthetic_slack_thread_not_captured(self):
        ...
        env = {
            "ZEUS_SESSION_PLATFORM": "slack",
            "ZEUS_SESSION_CHAT_ID": "D0BJTDCSR7C",
            "ZEUS_SESSION_THREAD_ID": "1755043010.123456",
            "ZEUS_SESSION_MESSAGE_ID": "1755043010.123456",
        }
    ...
    def test_genuine_slack_thread_preserved(self):
        ...
        env = {
            "ZEUS_SESSION_PLATFORM": "slack",
            "ZEUS_SESSION_CHAT_ID": "C0AGENERAL",
            "ZEUS_SESSION_THREAD_ID": "1755040000.000100",
            "ZEUS_SESSION_MESSAGE_ID": "1755043010.123456",
        }
        with _session_env(env):
            origin = _origin_from_env()
    ...
    def test_non_slack_platform_thread_untouched(self):
        ...
        env = {
            "ZEUS_SESSION_PLATFORM": "telegram",
            "ZEUS_SESSION_CHAT_ID": "-1003941067111",
            "ZEUS_SESSION_THREAD_ID": "2203",
            "ZEUS_SESSION_MESSAGE_ID": "2203",
        }
        with _session_env(env):
            origin = _origin_from_env()
        assert origin is not None
