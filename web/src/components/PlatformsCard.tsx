            ...
            >
              <div className="flex items-center gap-3 min-w-0 w-full">
                ...
                <div className="flex flex-col gap-0.5 min-w-0">
                  <span className="font-sans normal-case text-sm font-medium capitalize truncate">
                    {name}
                  </span>

                  {info.error_message && (
                    <span
                      className={`font-sans normal-case text-xs ${
                        info.state === "disabled"
                          ? "text-muted-foreground"
                          : "text-destructive"
                      }`}
                  ...
                  {info.updated_at && (
                    <span className="font-sans normal-case text-xs text-muted-foreground">
