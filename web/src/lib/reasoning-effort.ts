 ...
 *
 * Values mirror zeus_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the ZeusAgent default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (ZeusAgent' default when unset). */
