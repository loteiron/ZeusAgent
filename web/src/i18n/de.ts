...
export const de: Translations = {
  ...
  status: {
    ...
    stopped: "Gestoppt",
    updateZeusAgent: "ZeusAgent aktualisieren",
    updatingZeusAgent: "ZeusAgent wird aktualisiert…",
  ...
  pluginsPage: {
    ...
    headline:
      "ZeusAgent-Plugins entdecken, installieren, aktivieren und aktualisieren (entspricht `zeus plugins`).",
    ...
    removeConfirm: "Dieses Plugin aus ~/.zeus/plugins/ entfernen?",
    removeHint: "Nur vom Benutzer installierte Plugins unter ~/.zeus/plugins können entfernt werden.",
  ...
  skills: {
    ...
    filters: "Filter",
    noSkills: "Keine Skills gefunden. Skills werden aus ~/.zeus/skills/ geladen",
  ...
  env: {
    ...
    customHint: "Beliebige Umgebungsvariablen in deiner .env, die ZeusAgent nicht erkennt. Verwende sie, um Umgebungsvariablen für Skills, MCP-Server oder eigene Tools einzuschleusen.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Sammelbare ZeusAgent-Abzeichen, verdient durch echten Sitzungsverlauf. Bekannte, noch nicht abgeschlossene Achievements werden als Entdeckt angezeigt; geheime Achievements bleiben verborgen, bis das erste passende Verhalten auftritt.",
      scan_subtitle:
        "ZeusAgent-Sitzungsverlauf wird gescannt. Der erste Scan kann bei umfangreichem Verlauf 5–10 Sekunden dauern.",
    },
    actions: {
      rescan: "Neu scannen",
    },
    stats: {
      ...
      latest: "Neueste",
      latest_hint_empty: "nutze ZeusAgent mehr",
      none_yet: "Noch keine",
    },
    state: {
      unlocked: "Freigeschaltet",
    ...
    guide: {
      ...
      secret_body:
        "Geheimnisse verbergen ihren genauen Auslöser. Sobald ZeusAgent ein verwandtes Signal erkennt, wird die Karte zu Entdeckt und zeigt ihre Anforderung an.",
      scan_status_header: "Scan-Status",
      scan_status_body:
        "ZeusAgent scannt den lokalen Verlauf einmalig, danach erscheinen die Karten automatisch. Es ist nichts hängengeblieben, wenn dies ein paar Sekunden dauert.",
