...
export interface Translations {
  ...
  status: {
    ...
    updateZeusAgentConfirmMessage?: string;
    updateZeusAgentConfirmNow?: string;
    updateZeusAgentConfirmTitle?: string;
    updatingZeusAgent: string;
  ...
  // ── Achievements plugin (plugins/zeus-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
