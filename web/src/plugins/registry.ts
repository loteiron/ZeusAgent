 ...
 *
 * Plugins call window.__ZEUS_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__ZEUS_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__ZEUS_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__ZEUS_PLUGIN_SDK__ = {
    ...
    // window.__ZEUS_SESSION_TOKEN__ directly.
    authedFetch,
