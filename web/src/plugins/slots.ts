 ...
 * `window.__ZEUS_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the ZeusAgent brand in the top bar
 ...
 *  `window.__ZEUS_PLUGINS__.registerSlot(...)`.
 *
