/**
 * ZeusAgent Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__ZEUS_PLUGIN_SDK__`` and
 * ``window.__ZEUS_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__ZEUS_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``ZeusAgentPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@zeus/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__ZEUS_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__ZEUS_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__ZEUS_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface ZeusAgentPluginSDK {
...
declare global {
  interface Window {
    __ZEUS_PLUGIN_SDK__?: ZeusAgentPluginSDK;
    __ZEUS_PLUGINS__?: PluginRegistry;
  }
}
