  ...
  return (
    <Card>
      <CardHeader>
        ...
        <div className="flex items-center gap-4 font-sans normal-case text-xs text-muted-foreground">
      ...
      <CardContent>
            ...
            return (
              ...
              >
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block z-10 pointer-events-none">
                  <div className="font-sans normal-case bg-card border border-border px-2.5 py-1.5 text-xs text-foreground shadow-lg whitespace-nowrap">
        ...
        <div className="flex justify-between mt-2 font-sans normal-case text-xs text-text-tertiary">
    ...
    <Card>
      ...
      <CardContent>
        <div className="overflow-x-auto">
          <table className="w-full font-sans normal-case text-sm">
            <thead>
        ...
        <Card>
          <CardContent className="py-12">
            <div className="mx-auto flex max-w-2xl flex-col gap-3 text-sm text-muted-foreground">
              <h2 className="font-sans text-display text-base tracking-wider text-foreground">
