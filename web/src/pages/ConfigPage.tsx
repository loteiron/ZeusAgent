        ...
        <div key={key}>
          {showCatBadge && (
            <div className="flex items-center gap-2 pt-4 pb-2 first:pt-0">
              ...
              />
              <span className="font-sans text-display text-xs font-semibold tracking-wider text-muted-foreground">
          ...
          <aside aria-label={t.config.filters} className="sm:w-56 sm:shrink-0">
            <div className="sm:sticky sm:top-4">
              <div className="flex flex-col border border-border bg-muted/20">
                ...
                <div className="hidden sm:block px-3 pt-2 pb-1 font-sans text-display text-xs tracking-[0.12em] text-text-tertiary">
                  {t.config.sections}
                </div>
                  ...
                  {categories.map((cat) => {
                    ...
                    return (
                      <ListItem
                        ...
                        className="rounded-lg whitespace-nowrap px-2 py-1 text-xs"
                      >
                        <CategoryIcon
                          category={cat}
