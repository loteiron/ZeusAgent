...
// Mirrors zeus_cli/profiles.py::_PROFILE_ID_RE so we can reject obviously
          ...
          >
            ...
            <div className="min-h-0 overflow-y-auto p-5 grid gap-4">
              ...
              <fieldset className="grid gap-3 border-t border-border pt-4">
                <legend className="font-sans text-display text-xs tracking-wider text-muted-foreground">
                  {L.advancedOptions}
                </legend>
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <Label
                    className={cn(
                      "font-sans normal-case tracking-normal text-sm cursor-pointer",
                      !cloning && "opacity-50",
                    )}
                    htmlFor="clone-all"
                  >
                ...
                <>
                  <div className="flex items-center justify-between gap-2">
                    <Label
                      ...
                      className="font-sans text-display text-xs tracking-wider text-muted-foreground"
                    >
                      {L.description}
                    </Label>
