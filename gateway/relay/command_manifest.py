...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _cmd("reset", "Reset your ZeusAgent session"),
        ...
        _cmd("status", "Show ZeusAgent session status"),
        _cmd("sethome", "Set this chat as the home channel"),
        _cmd("stop", "Stop the running ZeusAgent agent"),
        ...
        _cmd("update", "Update ZeusAgent to the latest version"),
        _cmd("restart", "Gracefully restart the ZeusAgent gateway"),
        ...
        _cmd("thread", "Create a new thread and start a ZeusAgent session in it",
