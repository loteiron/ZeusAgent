...
class WhatsAppBehaviorMixin:
    ...
    DEFAULT_REPLY_PREFIX: str = "⚡ *ZeusAgent*\n────────────\n"
...
def resolve_whatsapp_bridge_dir() -> Path:
    ...
    try:
        ...
        pass
    if zeus_home_bridge.exists():
        return zeus_home_bridge
    try:
        zeus_home_bridge.parent.mkdir(parents=True, exist_ok=True)
        shutil.copytree(install_bridge, zeus_home_bridge, dirs_exist_ok=False)
        return zeus_home_bridge
    except Exception:
        return install_bridge
