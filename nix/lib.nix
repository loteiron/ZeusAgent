      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via ZEUS_BUNDLED_SKILLS /
            # ZEUS_OPTIONAL_SKILLS (see zeus-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + ZEUS_BUNDLED_LOCALES
            # / ZEUS_OPTIONAL_MCPS, not via the wheel. Excluding them
