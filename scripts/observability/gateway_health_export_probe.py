...
def main() -> None:
    ...
    zeus_home = Path(tempfile.mkdtemp(prefix="zeus-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "zeus-gateway-smoke",
    ...
    print(json.dumps({"zeus_home": str(zeus_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
