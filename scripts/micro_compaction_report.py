#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from ZeusAgent logs.
...
With no LOGFILE, reads ``$ZEUS_HOME/logs/agent.log`` (default ~/.zeus).
...
def default_log() -> Path:
    home = os.environ.get("ZEUS_HOME") or str(Path.home() / ".zeus")
