#!/usr/bin/env python3
"""Build the ZeusAgent Skills Index — a centralized JSON catalog of all skills.
...
`zeus skills search/install` can use it without hitting the GitHub API.
...
# Ensure ZEUS_HOME is set (needed by tools/skills_hub*.py imports)
...
def main():
    print("Building ZeusAgent Skills Index...", flush=True)
