#!/usr/bin/env python3
"""Build the ZeusAgent Model Catalog — a centralized JSON manifest of curated models.
...
ZeusAgent CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a ZeusAgent release.
...
# Ensure ZEUS_HOME is set for imports that touch it at module level.
os.environ.setdefault("ZEUS_HOME", os.path.join(os.path.expanduser("~"), ".zeus"))

from zeus_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
            ...
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model ZeusAgent '
