...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^ZeusAgent\s+(Agent|Audit)$", re.IGNORECASE),
    ...
    re.compile(r".*\[bot\]$", re.IGNORECASE),             # any GitHub [bot] suffix (zeus-seaeye[bot] etc.)
...
IGNORED_EMAILS = {
    ...
    "zeus@nousresearch.com",
    "zeus-audit@example.com",
