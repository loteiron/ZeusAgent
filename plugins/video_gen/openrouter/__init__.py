...
materialize the completed clip under ZeusAgent' video cache.
"""
...
def _build_payload(
    *,
    ...
    """Translate the unified ZeusAgent inputs to OpenRouter's video API."""
...
class OpenRouterVideoGenProvider(VideoGenProvider):
    ...
    def _headers(self) -> Dict[str, str]:
        return {
            ...
            "User-Agent": "zeus-agent/video_gen",
        }
