...
When running ZeusAgent inside Docker, the default `network_mode: host` gives the
...
The ZeusAgent [SECURITY.md](../../SECURITY.md) §2 defines the trust model. The
...
#
# Usage:
#   ZEUS_UID=$(id -u) ZEUS_GID=$(id -g) docker compose up -d
#
...
services:
  gateway:
    ...
    environment:
      ...
      - NO_PROXY=zeus,zeus-dashboard,localhost
...
- [SECURITY.md](../../SECURITY.md) — ZeusAgent trust model and vulnerability reporting
