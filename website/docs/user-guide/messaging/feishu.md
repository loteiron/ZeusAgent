...
Error codes 200672 / 200673 mean the callback *did* reach ZeusAgent and Feishu rejected the response payload; those are adapter bugs — please file an issue with the gateway log.
