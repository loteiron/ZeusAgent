...
| | |
|---|---|
| Source | Optional — install with `zeus skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain\evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), ZeusAgent |
| License | MIT |
...
Helper script path: `~/.zeus/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.zeus/skills/blockchain/evm/scripts/evm_client.py
...
python ~/.zeus/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python ~/.zeus/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
