...
| | |
|---|---|
| Source | Optional — install with `zeus skills install official/finance/stocks` |
| Path | `optional-skills/finance\stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), ZeusAgent |
| License | MIT |
...
```
SCRIPT=~/.zeus/skills/finance/stocks/scripts/stocks_client.py
...
```
python ~/.zeus/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
