...
| | |
|---|---|
| Source | Optional — install with `zeus skills install official/productivity/shop` |
| Path | `optional-skills/productivity\shop` |
| Version | `1.0.1` |
| Author | Joe Rinaldi Johnson (joerj123), ZeusAgent |
| License | MIT |
...
| Telegram (ZeusAgent + all other agents) | Do **not** send an image. Send separate messages — never one combined message. |
