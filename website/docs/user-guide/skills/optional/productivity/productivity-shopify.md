...
| | |
|---|---|
| Source | Optional — install with `zeus skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"ZeusAgent","productType":"Apparel","tags":["test"]}}'
```
