...
| | |
|---|---|
| Source | Optional — install with `zeus skills install official/health/neuroskill-bci` |
...
Connect ZeusAgent to a running [NeuroSkill](https://neuroskill.com/) instance to read
