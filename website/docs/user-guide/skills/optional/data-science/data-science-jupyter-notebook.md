...
| | |
|---|---|
| Source | Optional — install with `zeus skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing zeus tool access (web_search, file ops). Stateless. |
