...
| | |
|---|---|
| Source | Optional — install with `zeus skills install official/creative/hyperframes` |
...
```bash
bash "$(dirname "$(find ~/.zeus/skills -path '*/hyperframes/SKILL.md' 2>/dev/null | head -1)")/scripts/setup.sh"
```
