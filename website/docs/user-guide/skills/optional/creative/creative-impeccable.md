...
| | |
|---|---|
| Source | Optional — install with `zeus skills install official/creative/impeccable` |
...
> ships and verifies a ZeusAgent-native skill bundle under `.zeus/skills/`.
> `zeus skills install impeccable` pulls the current bundle live from that
