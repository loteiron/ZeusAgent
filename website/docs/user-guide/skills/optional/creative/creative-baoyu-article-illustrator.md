...
| | |
|---|---|
| Source | Optional — install with `zeus skills install official/creative/baoyu-article-illustrator` |
...
Adapted from [baoyu-article-illustrator](https://github.com/JimLiu/baoyu-skills) for ZeusAgent's tool ecosystem.
