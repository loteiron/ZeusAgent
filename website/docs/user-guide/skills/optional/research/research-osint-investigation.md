...
| | |
|---|---|
| Source | Optional — install with `zeus skills install official/research/osint-investigation` |
| Path | `optional-skills/research\osint-investigation` |
| Version | `0.1.0` |
| Author | ZeusAgent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $ZEUS_OSINT_CACHE/icij/ (default: ~/.cache/zeus-osint/icij/).
...
# Set ZEUS_OSINT_UA=your-app/1.0 (your@email) to identify yourself
