...
| | |
|---|---|
| Source | Optional — install with `zeus skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`zeus-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-zeus-agent), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
ZeusAgent via the native MCP client. This is the preferred
...
Then configure ZeusAgent to connect via HTTP:
