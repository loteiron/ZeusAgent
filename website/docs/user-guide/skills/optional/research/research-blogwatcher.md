...
| | |
|---|---|
| Source | Optional — install with `zeus skills install official/research/blogwatcher` |
...
## Working with ZeusAgent tools (read this first)

`blogwatcher-cli` is the feed database; ZeusAgent tools do the automation around it:
