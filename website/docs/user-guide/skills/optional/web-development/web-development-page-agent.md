...
| | |
|---|---|
| Source | Optional — install with `zeus skills install official/web-development/page-agent` |
...
- User wants **ZeusAgent itself to drive a browser** → use ZeusAgent' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
