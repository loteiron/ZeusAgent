...
| [`zeus-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-zeus-agent) | Use, configure, theme, extend, and orchestrate ZeusAgent. | `autonomous-ai-agents\zeus-agent` |
...
| [`zeus-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-zeus-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development\zeus-agent-skill-authoring` |
| [`inspecting-zeus-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-zeus-desktop-dom) | Read the live ZeusAgent desktop DOM/CSS over CDP. | `software-development\inspecting-zeus-desktop-dom` |
