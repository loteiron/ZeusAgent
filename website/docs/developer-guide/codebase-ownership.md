...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `zeus_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `zeus_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a ZeusAgent Plugin](plugins/index.md) |
...
| Session storage | `zeus_state.py`, `zeus_state_*.py` | [Session Storage](session-storage.md) |
