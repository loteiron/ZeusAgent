...
description: "How the ZeusAgent Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the ZeusAgent Desktop app connects to a **gated gateway** (a hosted or
...
For ZeusAgent specifically, native sign-in means:
...
- [Run ZeusAgent with Nous Portal](./run-zeus-with-nous-portal.md)
