---
sidebar_position: 8
title: "Use Voice Mode with ZeusAgent"
description: "A practical guide to setting up and using ZeusAgent voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with ZeusAgent
...
- you want ZeusAgent sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in ZeusAgent.
...
## Step 1: make sure normal ZeusAgent works first
...
ZeusAgent supports both local and cloud speech stacks.
...
4. ZeusAgent transcribes and responds
...
- asking ZeusAgent to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full ZeusAgent loop.

## Tuning CLI behavior

### Silence threshold

If ZeusAgent starts/stops too aggressively, tune:
...
ZeusAgent stays a normal chat bot, but can speak replies.
...
- you want ZeusAgent to function like a portable research or ops assistant
...
ZeusAgent joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- ZeusAgent detects speech boundaries
- transcripts are posted in the associated text channel
- ZeusAgent responds in text and audio
...
1. get text ZeusAgent working
2. run `zeus setup tts` to enable voice support
