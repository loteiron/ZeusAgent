#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the ZeusAgent docs site.
...
LLM reads to learn what ZeusAgent does.
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use ZeusAgent as a Python Library", None),
        ("guides/use-mcp-with-zeus", "Use MCP with ZeusAgent", None),
        ("guides/use-voice-mode-with-zeus", "Use Voice Mode with ZeusAgent", None),
        ("guides/use-soul-with-zeus", "Use SOUL.md with ZeusAgent", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with ZeusAgent"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "zeus-agent/main/scripts/install.sh | bash`  "
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# ZeusAgent — Full Documentation\n",
        (
            "This file is the entire ZeusAgent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using ZeusAgent, Features, Messaging, Integrations, Guides, "
