  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the ZeusAgent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use ZeusAgent &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with ZeusAgent?{' '}
        <a
