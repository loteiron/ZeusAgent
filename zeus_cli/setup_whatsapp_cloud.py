...
def run_whatsapp_cloud_setup() -> int:
    ...
    _lines(
        ...
        "This wizard configures ZeusAgent to talk to WhatsApp via Meta's",
    ...
    _lines(
        "", "  ZeusAgent needs a public HTTPS URL to receive WhatsApp messages.",
        ...
        "    3. Start the ZeusAgent gateway in another terminal:",
        "         zeus gateway", "",
