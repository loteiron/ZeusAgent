...
Invoked by ``zeus kanban decompose [task_id | --all]`` and the gateway
...
from zeus_cli.kanban_db_graph import decompose_triage_task
from zeus_cli import kanban_db_connect as kbc
from zeus_cli import profiles as profiles_mod
from zeus_cli.kanban_specify import (
    _call_aux, _extract_json_blob, _load_triage_task, _task_prompt_fields, _title_body,
)
from zeus_cli.kanban_specify import _profile_author as _specify_author

logger = logging.getLogger(__name__)


_SYSTEM_PROMPT = """You are the Kanban decomposer for the ZeusAgent board.
...
def _profile_author() -> str:
    """Mirror of ``zeus_cli.kanban._profile_author``."""
