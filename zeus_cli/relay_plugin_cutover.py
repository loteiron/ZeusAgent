"""Shared migration guards for ZeusAgent' native NeMo Relay ownership."""
...
RELAY_PLUGINS_CONFIG_ENV = "ZEUS_NEMO_RELAY_PLUGINS_TOML"

LEGACY_RELAY_PLUGIN_KEYS = frozenset({"nemo_relay", "observability/nemo_relay"})

LEGACY_RELAY_EXPORT_ENV_VARS = frozenset({
    "ZEUS_NEMO_RELAY_ATOF_ENABLED",
    "ZEUS_NEMO_RELAY_ATOF_OUTPUT_DIRECTORY",
    "ZEUS_NEMO_RELAY_ATOF_FILENAME",
    "ZEUS_NEMO_RELAY_ATOF_MODE",
    "ZEUS_NEMO_RELAY_ATIF_ENABLED",
    "ZEUS_NEMO_RELAY_ATIF_OUTPUT_DIRECTORY",
    "ZEUS_NEMO_RELAY_ATIF_FILENAME_TEMPLATE",
    "ZEUS_NEMO_RELAY_ATIF_AGENT_NAME",
    "ZEUS_NEMO_RELAY_ATIF_AGENT_VERSION",
    "ZEUS_NEMO_RELAY_ATIF_EXPORT_TIMEOUT_S",
    "ZEUS_NEMO_RELAY_ATIF_MODEL_NAME",
    "ZEUS_NEMO_RELAY_ATIF_SUBAGENT_EXPORT_MODE",
})
