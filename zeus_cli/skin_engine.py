"""ZeusAgent skin/theme engine — the theme SDK for every surface."""
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces ZEUS_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces ZEUS_CADUCEUS)
...
def _branding(who: str, symbol: str, goodbye: str, prompt: str = "", help_header: str = "") -> Dict[str, str]:
    ...
    title = who if who.endswith("Agent") else f"{who} Agent"
    return {
        "agent_name": title,
        "welcome": f"Welcome to {title}! Type your message or /help for commands.",
...
# Branding shared by every ZeusAgent-named built-in (mono/daylight override help_header).
_ZEUS_BRANDING: Dict[str, str] = _branding(
    "ZeusAgent", "Z/", "Workspace closed. See you next time.", prompt="❯", help_header="ZeusAgent / Commands")
_ZEUS_BRANDING["welcome"] = "Describe your task. Use /help to explore commands."

_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default", "description": "ZeusAgent — storm blue and copper task console",
        "colors": {
            "banner_border": "#7892B2", "banner_title": "#92B9DD", "banner_accent": "#E6AB80",
            "banner_dim": "#A0B1C8", "banner_text": "#E5EDF7",
            "ui_accent": "#E6AB80", "ui_label": "#92B9DD", "ui_ok": "#9FCDBB",
            "ui_error": "#F09D9F", "ui_warn": "#E6C287", "prompt": "#E6AB80",
            "input_rule": "#7892B2", "response_border": "#92B9DD", "status_bar_bg": "#172842",
            "status_bar_text": "#E5EDF7", "status_bar_strong": "#92B9DD", "status_bar_dim": "#A0B1C8",
            "status_bar_good": "#9FCDBB", "status_bar_warn": "#E6C287", "status_bar_bad": "#E6AB80",
            "status_bar_critical": "#F09D9F", "session_label": "#A0B1C8", "session_border": "#A0B1C8",
            "completion_menu_bg": "#172842", "completion_menu_current_bg": "#2B405B", "selection_bg": "#345174",
            "shell_dollar": "#92B9DD", "voice_status_bg": "#172842",
        },
        "light_colors": {
            "banner_border": "#617793", "banner_title": "#315B83", "banner_accent": "#A85F32",
            "banner_dim": "#526680", "banner_text": "#162743",
            "ui_accent": "#A85F32", "ui_label": "#315B83", "ui_ok": "#326E57",
            "ui_error": "#AA4049", "ui_warn": "#885D1F", "prompt": "#A85F32",
            "input_rule": "#617793", "response_border": "#315B83", "status_bar_bg": "#F7FAFD",
            "status_bar_text": "#162743", "status_bar_strong": "#315B83", "status_bar_dim": "#526680",
            "status_bar_good": "#326E57", "status_bar_warn": "#885D1F", "status_bar_bad": "#A85F32",
            "status_bar_critical": "#AA4049", "session_label": "#526680", "session_border": "#526680",
            "completion_menu_bg": "#F7FAFD", "completion_menu_current_bg": "#D9E4F0", "selection_bg": "#CADAE9",
            "shell_dollar": "#315B83", "voice_status_bg": "#F7FAFD",
        },
        "spinner": {
            "waiting_faces": ["[.  ]", "[.. ]", "[...]"],
            "thinking_faces": ["[/]", "[-]", "[\\]", "[|]"],
            "thinking_verbs": ["planning", "checking", "working", "reviewing"],
            "wings": []},
        "branding": _ZEUS_BRANDING,
        "tool_prefix": "┊"},
    "ares": {
    ...
    "mono": {
        ...
        "spinner": {},
        "branding": {**_ZEUS_BRANDING, "help_header": "[?] Available Commands"},
        "tool_prefix": "┊"},
    "slate": {
        ...
        "spinner": {}, "branding": _ZEUS_BRANDING, "tool_prefix": "┊"},
    "daylight": {
        "name": "daylight",
...
# Existing Zeus profiles resolve to the same complete paired palette.
_BUILTIN_SKINS["zeus"] = {**_BUILTIN_SKINS["default"], "name": "zeus"}
...
def get_active_help_header(fallback: str = "ZeusAgent / Commands") -> str:
    return _active_branding("help_header", fallback)


def get_active_goodbye(fallback: str = "Workspace closed. See you next time.") -> str:
...
_STYLE_PALETTE = (
    ("prompt", "prompt", ""), ("input_rule", "input_rule", "#7892B2"),
    ("title", "banner_title", "#92B9DD"), ("text", "banner_text", "#E5EDF7"),
    ("dim", "banner_dim", "#A0B1C8"), ("label", "ui_label", "@title"), ("warn", "ui_warn", "#FF8C00"),
    ("error", "ui_error", "#FF6B6B"), ("status_bg", "status_bar_bg", "#172842"),
    ...
    ("menu_bg", "completion_menu_bg", "#172842"), ("menu_current_bg", "completion_menu_current_bg", "#2B405B"),
...
def get_prompt_toolkit_style_overrides() -> Dict[str, str]:
    ...
    palette["badge_bg"] = skin.colors.get(
        "status_bar_strong", skin.colors.get("banner_title", "#92B9DD"))
    palette["badge_fg"] = skin.colors.get("status_bar_bg", "#172842")
