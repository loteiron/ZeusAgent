"""ZeusAgent middleware contract helpers.
...
OBSERVER_SCHEMA_VERSION = "zeus.observer.v1"
MIDDLEWARE_SCHEMA_VERSION = "zeus.middleware.v1"
...
def _apply_request_chain(
    ...
    from zeus_cli.plugins import invoke_middleware
...
def apply_llm_request_middleware(request: Dict[str, Any], **context: Any) -> RequestMiddlewareResult:
    ...
    from zeus_cli.plugins import has_middleware
