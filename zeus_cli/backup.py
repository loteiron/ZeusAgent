...
# ZeusAgent-managed runtime downloads (GGUF models, llama.cpp runtimes, managed Node) and caches are
...
# ONLY at the root of ZEUS_HOME and at ``profiles/<name>/`` — a deeper directory of the same name
