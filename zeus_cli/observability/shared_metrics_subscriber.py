"""Relay subscriber for the persisted ZeusAgent shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated ZeusAgent counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the ZeusAgent shared metric: %s", metric_name, exc_info=True
                )
