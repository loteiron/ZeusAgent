...
def build_gui_parser(subparsers, *, cmd_gui: Callable) -> None:
    ...
    gui_parser = subparsers.add_parser(
        ...
        description="Launch the ZeusAgent Electron desktop app. By default this installs "
    ...
    gui_parser.add_argument(
        ...
        help="Force Desktop to ignore any zeus CLI already on PATH during backend resolution")
    gui_parser.add_argument(
        "--zeus-root",
        help="Override the ZeusAgent source root used by Desktop (sets ZEUS_DESKTOP_ZEUS_ROOT)")
    gui_parser.add_argument(
        "--cwd",
        help="Initial project directory for Desktop chat sessions (sets ZEUS_DESKTOP_CWD)")
    gui_parser.add_argument(
    ...
    gui_parser.add_argument(
        "--identity", default="ZeusAgent Local Signing",
        help="Certificate name to create/use for --setup-tcc-identity (default: ZeusAgent Local Signing)",
    )
