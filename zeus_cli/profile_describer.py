...
Mirrors ``zeus_cli/kanban_specify.py``: lazy aux client import, lenient response parse,
...
_SYSTEM_PROMPT = """You are a profile-describer for the ZeusAgent kanban board.
...
Rules:
  ...
  - Never write "ZeusAgent profile" or other meta-narration.
...
def _extract_json_blob(raw: str) -> Optional[dict]:
    from zeus_cli.kanban_specify import _extract_json_blob as _extract
