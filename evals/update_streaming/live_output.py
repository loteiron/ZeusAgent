...
def step(mode):
    from zeus_cli.main_dashboard import _install_hangup_protection, _finalize_update_output
    from zeus_cli.main import _run_logged_subprocess
