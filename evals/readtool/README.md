...
benchmarked ten harnesses on hostile-file handling — and whose ZeusAgent column
...
Every task runs the full ZeusAgent agent (file + terminal + search toolsets)
...
Rules of engagement (from zeusbench discipline):
