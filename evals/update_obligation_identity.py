...
os.environ["ZEUS_HOME"] = str(root / ".zeus")
from zeus_cli import update_cmd_fleet as fleet, update_receipt as receipts
...
try:
    for name in ["alpha", "beta"]:
        ...
        p = subprocess.Popen(
            ...
            cwd=repo,
            env={**os.environ, "ZEUS_HOME": str(home)},
    ...
    d = root / ".zeus/logs/update_receipts"
