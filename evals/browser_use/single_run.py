...
The run gets a throwaway ZEUS_HOME so no local config leaks in, and the
...
if _or_key:
    ...
    # Resolved by the orchestrator BEFORE ZEUS_HOME is redirected to the
