...
def run_case(root, output, name, behind, early=False, cancel=False):
    with tempfile.TemporaryDirectory(prefix="zeus_test_notice_") as home:
        hh = Path(home) / ".zeus"
        hh.mkdir()
        ...
        from zeus_cli.banner import VERSION
        ...
        bootstrap = ("import zeus_cli.main as m; import zeus_cli.banner as b; "
        ...
        try:
            ...
            result = {"case": name, "ready": ready, "exited": exited,
                      ...
                      "loaded_worktree": str(root / "zeus_cli/banner.py") in text,
