...
from zeus_cli import cli_commands_mixin, goals
...
server._zeus_home = Path(home.name)
...
with patch('zeus_cli.goals.draft_contract', return_value=None), contextlib.redirect_stdout(io.StringIO()):
