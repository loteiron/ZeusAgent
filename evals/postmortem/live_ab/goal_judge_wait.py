...
os.environ.setdefault("ZEUS_HOME", os.path.expanduser("~/.zeus"))  # LIVE: real auxiliary judge calls (cents)
from zeus_cli import goals
goal = ("Simplify the zeus-agent codebase by >=30% LOC with zero behavior change, decomposing every god file, "
