...
# Temp ZEUS_HOME with the real auth + a config that shortens the generic sequential deadline to 40 s, so the
...
home = tempfile.mkdtemp(prefix="dl_home_"); os.environ["ZEUS_HOME"] = home
real_home = os.environ.get("ZEUS_HOME_SOURCE", os.path.expanduser("~/.zeus"))  # credentials are copied from here into a temp home
