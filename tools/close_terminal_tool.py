"""Close a read-only agent terminal tab in the ZeusAgent desktop GUI WITHOUT killing
...
CLOSE_TERMINAL_SCHEMA = {
    ...
    "description": (
        ...
        "the ZeusAgent desktop GUI (the tabs mirroring terminal(background=true) runs). "
