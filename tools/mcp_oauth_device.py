...
started by `zeus mcp login/reauth`, never a background reconnect.
"""
...
async def login_device(name, server_url, oauth_config):
    ...
    from tools.mcp_oauth_manager import ZeusAgentMCPOAuthProvider, get_manager
    ...
    provider = ZeusAgentMCPOAuthProvider(server_url=server_url, server_name=name, storage=storage,
