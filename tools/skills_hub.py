...
Used by zeus_cli/skills_hub.py for CLI commands and the /skills slash command.
"""
...
_skills_dir = _path_resolver("SKILLS_DIR", "ZEUS_HOME", "skills")
...
_DYNAMIC_PATH_RESOLVERS = {"ZEUS_HOME": _zeus_home, **{
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'ZEUS_INDEX_TTL': ('tools.skills_hub_search', 'ZEUS_INDEX_TTL'),
    'ZEUS_INDEX_URL': ('tools.skills_hub_search', 'ZEUS_INDEX_URL'),
    'ZeusAgentIndexSource': ('tools.skills_hub_official', 'ZeusAgentIndexSource'),
