...
# is treated as a self-capture of ZeusAgent' own TTS: the full-duplex listener has no echo
...
def is_tts_echo(transcript: str, spoken_text: str,
    ...
    (language-agnostic): a genuine interjection rarely matches ZeusAgent' own words, so a high ratio signals
