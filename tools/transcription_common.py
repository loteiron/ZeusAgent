...
LOCAL_STT_COMMAND_ENV = "ZEUS_LOCAL_STT_COMMAND"
LOCAL_STT_LANGUAGE_ENV = "ZEUS_LOCAL_STT_LANGUAGE"
...
# DeepInfra STT base URL is resolved via zeus_cli.models.deepinfra_base_url (shared).
