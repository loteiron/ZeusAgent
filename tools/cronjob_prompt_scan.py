...
# containing `cat ~/.zeus/.env` or `rm -rf /`; there it is a smoking gun, not prose.
...
# `zeus-agent-dev` skill contains a security postmortem mentioning `cat ~/.zeus/.env`, which tripped
