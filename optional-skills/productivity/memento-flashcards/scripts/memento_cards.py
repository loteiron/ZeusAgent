...
Data file: $ZEUS_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ZEUS_HOME = Path(os.environ.get("ZEUS_HOME", Path.home() / ".zeus"))
DATA_DIR = _ZEUS_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
