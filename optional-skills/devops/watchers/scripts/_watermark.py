...
def _state_dir() -> Path:
    ...
    # Default: $ZEUS_HOME/watcher-state/, falling back to ~/.zeus/watcher-state/.
    zeus_home = os.environ.get("ZEUS_HOME") or str(Path.home() / ".zeus")
    return Path(zeus_home) / "watcher-state"
