 ...
 *
 * Each entry is a key/value pair that lands in the packaged ZeusAgent.app's
 ...
 * "ZeusAgent wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("ZeusAgent wants to access Music" when ZeusAgent never touches the Music
