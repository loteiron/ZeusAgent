...
def summarize_server(name: str, cfg: dict) -> Dict[str, Any]:
    ...
    """
    from zeus_cli.mcp_config import _oauth_tokens_present
...
def resolve_profile(rid, params, err_fn) -> Tuple[Optional[Any], Optional[dict]]:
    """Resolve the optional ``profile`` param to a ZEUS_HOME override token.
    ...
    return set_zeus_home_override(str(profile_dir)), None
# ---- END PLUGIN-COMPAT ----
