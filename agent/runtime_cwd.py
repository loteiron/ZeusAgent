...
_SESSION_CWD: ContextVar = ContextVar("ZEUS_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    launch dir). An existing configured path is honored verbatim — including the ZeusAgent source tree, a
    legitimate workspace when developing ZeusAgent; fallback-directory policy lives in the caller."""
